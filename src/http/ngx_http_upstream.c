...
{//ngx_http_upstream_initµ÷ÓÃÕâÀï£¬´ËÊ±¿Í»§¶Ë·¢ËÍµÄÊý¾Ý¶¼ÒÑ¾­½ÓÊÕÍê±ÏÁË¡£
    ...
    u->output.output_filter = ngx_chain_writer;//ÉèÖÃ¹ýÂËÄ£¿éµÄ¿ªÊ¼¹ýÂËº¯ÊýÎªwriter¡££¬Ò²¾ÍÊÇoutput_filter
...
//ÕâÀï¸ºÔðÁ¬½Óºó¶Ë·þÎñ£¬È»ºóÉèÖÃ¸÷¸ö¶ÁÐ´ÊÂ¼þ»Øµ÷¡£×îºóÈç¹ûÁ¬½Ó½¨Á¢³É¹¦£¬»áµ÷ÓÃngx_http_upstream_send_request½øÐÐÊý¾Ý·¢ËÍ¡£
    ...
    c->write->handler = ngx_http_upstream_handler;//ÉèÖÃÕâ¸öÁ¬½ÓµÄ¶ÁÐ´ÊÂ¼þ½á¹¹¡£ÕâÊÇÕæÕýµÄ¶ÁÐ´ÊÂ¼þ»Øµ÷¡£
    ...
    {//request_bodyÊÇFCGI½á¹¹µÄÊý¾Ý¡£
        ...
        u->output.free->buf = r->request_body->buf;//Ö¸ÏòÇëÇóµÄBODYÊý¾Ý²¿·Ö£¬É¶ÒâË¼?
...
{//µ÷ÓÃÊä³öµÄ¹ýÂËÆ÷£¬·¢ËÍÊý¾Ýµ½ºó¶Ë
    ...
    u->request_sent = 1;//±êÖ¾Î»Êý¾ÝÒÑ¾­·¢ËÍÍê±Ï
...
{//Èç¹ûu´ú±íµÄserverÒÑ¾­´æÔÚ£¬Ôò·µ»Ø¾ä±ú£¬·ñÔòÔÚumcf->upstreamsÀïÃæÐÂ¼ÓÒ»¸ö£¬ÉèÖÃ³õÊ¼»¯¡£
	...
	//Ã»ÓÐÕÒµ½ÏàÍ¬µÄÅäÖÃupstream£¬ÏÂÃæ´´½¨Ò»¸ö¡£ÕâÀïµÄsrv_conf¸úserver{}²»ÊÇÒ»»ØÊÂ
